    ...
    <body>
        <%
            ...
            if (request.getParameter("submit") != null) {
                ...
                int res = stmt.executeUpdate("SELECT * FROM `login_details` WHERE username='" + request.getParameter("uname") + " AND password='" + request.getParameter("pass") + "");
                if (res > 0) {
        ...
        <div class="container p-5 mt-5">
            <div class='mt-5 col-md-12 d-flex justify-content-center'>
                <form action="index.jsp" method="POST" class="form border shadow rounded col-md-0 w-30 p-3 m-3">
